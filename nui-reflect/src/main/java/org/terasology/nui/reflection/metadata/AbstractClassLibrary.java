...
public abstract class AbstractClassLibrary<T> implements ClassLibrary<T> {
    ...
    private final Map<Class<? extends T>, ClassMetadata<? extends T, ?>> classLookup = Maps.newHashMap();
    private final Table<Name, Name, ClassMetadata<? extends T, ?>> uriLookup = HashBasedTable.create();
