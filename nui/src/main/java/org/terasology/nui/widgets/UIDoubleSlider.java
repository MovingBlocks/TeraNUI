...
public class UIDoubleSlider extends CoreWidget {
    ...
    private final InteractionListener tickerListenerLeft = new BaseInteractionListener() {
    ...
    private final InteractionListener tickerListenerRight = new BaseInteractionListener() {
        private final Vector2i offset = new Vector2i();
